...
(function(factory) {
  ...
  var defaults = {
    ...
    hookDocument: true,
    multiple: true,
    url: '<?php echo admin_url( 'admin-ajax.php' ).'?'.'page='.SWF_SLUG.'&opt=slides&action=uploadsilde&sliderid='.$_REQUEST['sliderid'];?>',//document.URL,
    method: "POST",
    extraData: {},
    headers: {},
    dataType: null,
  ...
  DmUploaderFile.prototype.upload = function()
  {
    ...
    fd.append('sliderid', '<?php echo $_REQUEST['sliderid'];?>');
