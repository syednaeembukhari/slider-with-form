...
<h1>Add Driving Licence Sanghar</h1>

<div class="pf-bg">

<div id="no-more-tables" class="table-responsive">

<table width="100%" class="col-md-12 table-bordered table-striped table-condensed cf">
  ...
  <tr>
    ...
    <a href="<?php echo $row->retialerfilelink;?>" >Download</a>
